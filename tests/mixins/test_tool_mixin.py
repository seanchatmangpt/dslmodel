...
import pytest
import json
import openai.chat.completions.create
...
class MockOpenAI:
    ...
    def create(self, model: str, messages: List[Dict[str, Any]], tools: Optional[List[Dict[str, Any]]] = None, **kwargs) -> Any:
    ...
    def _generate_request_signature(self, model: str, messages: List[Dict[str, Any]], tools: Optional[List[Dict[str, Any]]], kwargs: Dict[str, Any]) -> str:
        request_content = {
            'model': model,
            'messages': messages,
            'tools': tools,
