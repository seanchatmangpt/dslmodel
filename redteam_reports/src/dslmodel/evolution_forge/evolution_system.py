...
Fixed syntax errors and enhanced implementation.
"""
...
class EvolutionSystem:
    ...
    def emit_analyze(self, session_id: str, analysis_type: str, issues_found: int, 
        ...
        with tracer.start_as_current_span("dslmodel.evolution.analyze") as span:
            ...
            logger.debug(f"Emitted {span.name} for session {session_id}")
    ...
    def emit_generate(self, session_id: str, improvement_id: str, improvement_type: str, 
        ...
        with tracer.start_as_current_span("dslmodel.evolution.generate") as span:
            ...
            span.set_status(Status(StatusCode.OK))
            logger.debug(f"Emitted {span.name} for improvement {improvement_id}")
    ...
    def emit_apply(self, session_id: str, improvement_id: str, application_mode: str, 
        ...
        with tracer.start_as_current_span("dslmodel.evolution.apply") as span:
            ...
            logger.debug(f"Emitted {span.name} for improvement {improvement_id}: {application_result}")
    ...
    def emit_validate(self, session_id: str, improvement_id: str, validation_type: str,
        ...
        with tracer.start_as_current_span("dslmodel.evolution.validate") as span:
            ...
            logger.debug(f"Emitted {span.name} for improvement {improvement_id}: {validation_result}")
    ...
    def emit_worktree(self, session_id: str, worktree_id: str, worktree_action: str,
        ...
        with tracer.start_as_current_span("dslmodel.evolution.worktree") as span:
            ...
            span.set_status(Status(StatusCode.OK))
            logger.debug(f"Emitted {span.name} for worktree {worktree_id}: {worktree_action}")
