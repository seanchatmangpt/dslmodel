...
, examples=['performance', 'security', 'features', 'quality', 'architecture']    )
    fitness_before: Optional[str] = Field(
        None,
        description="System fitness score before evolution"
    )
    target_fitness: Optional[str] = Field(
        None,
...
...,
    ...
    mutation_description: Optional[str] = Field(
        None,
...
, examples=['low', 'medium', 'high', 'critical']    )
    rollback_capable: Optional[bool] = Field(
        None,
...
, examples=['assign_experiment', 'evaluate_fitness', 'select_candidates', 'merge_improvements']    )
    ...
    fitness_baseline: Optional[str] = Field(
        None,
        description="Current system fitness baseline"
    )
    improvement_target: Optional[str] = Field(
        None,
